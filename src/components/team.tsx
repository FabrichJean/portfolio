...
function TeamCard({
  ...
  return (
    <div className="card">
      ...
      <button className="btn-recruter" onClick={() => onRecruit(person)}>
        Recruter
        <svg
          width="18"
          height="18"
    ...
    `}
        ...
        `}
                  >
                    ...
                    {isActive && (
                      <>
                        <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-purple-300/50 to-transparent rounded-t-xl" />
